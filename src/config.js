export const GAME_CONFIG = {
  ...
  clients: {
    ...
    queueXOffset: 28,        // each client behind shifts this much horizontally
    queueYOffset: 14,        // and this much vertically (depth illusion)
    queueScale: 3,           // sprite scale for clients
    queueScaleFalloff: 0.85, // each further-back client shrinks by this factor
    queueAlphaFalloff: 0.75, // and dims

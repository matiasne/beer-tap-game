...
import { buildClientAtlas, COMMON_CHARACTERS } from '../clientSpriteSheet.js';
...
export default class BootScene extends Phaser.Scene {
  ...
  preload() {
    // Hand-editable sprite sheet — generated by `node scripts/build-sprite-sheet.js`.
    // If the files are missing (e.g. someone deleted them), buildClientAtlas()
    // falls back to drawing the atlas procedurally into a canvas at runtime.
    this.load.atlas('clients_atlas', 'sprites/clients.png', 'sprites/clients.json');
  ...
  makeGlassShape(shape) {
    ...
    // Outer dark rim line (sits above the lip).
    g.fillStyle(outline, 1);
    ...
    // Sparkle highlight on the upper-left of the lip (catches the light).
    g.fillStyle(highlight, 1);
    g.fillRect(cx - topHalf + 1, innerTop - 3, Math.min(4, topHalf), 1);
